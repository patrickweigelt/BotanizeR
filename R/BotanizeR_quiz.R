...
BotanizeR_quiz <- function(species_list, hints = c("image","description","status","habitat","family","German name")){
  ...
  # Arguments
  if(!all(hints %in% c("image","description","status","habitat","family","German name"))){
    stop('"hints" must be a subset of c("image","description","status","habitat","family","German name")')
  }
