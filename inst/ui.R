...
navbarPage(title = div(
    ...
    tags$script(HTML(paste0("var header = $('.navbar > .container-fluid');",
                            ...
                            BotanizeR_URL,"\" target=\"_blank\"><img src=\"twitter_bird_logo.png\" alt=\"alt\" ",
...
if(setup){tabPanel(
    ...
    fluidRow(
        column(4,
               ...
               numericInput("longitude", "Longitude:", 9.905548, step = 0.000001, min = -180, max = 180),
               numericInput("latitude", "Latitude:", 51.545483, step = 0.000001, min = -89, max = 89),
